  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="font-helvetica text-white max-w-[90%] sm:max-w-md mx-auto lg:max-w-[658px] font-normal text-[14px] sm:text-sm md:text-lg lg:text-xl text-center">
      ...
      <motion.div>
        <div className="pt-6 sm:pt-12.5 md:pt-[103px] pb-8 md:pb-[169px] px-6 md:px-8">
          <GridCard />
        </div>
      </motion.div>
    </section>
